...
void FaceDetector::onInit()
{
	 ...
	 */
	client_recognize_ = private_nh_.serviceClient<new_face_recognition::RecognizeFace>("/qbo_face_recognition/recognize_with_stabilizer");
	client_get_name = private_nh_.serviceClient<new_face_recognition::GetName>("/qbo_face_recognition/get_name");
